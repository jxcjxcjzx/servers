...
var picdir = '/home/jxcpso/jxc2014/PicSeeOne/PicSee_ServerSide/node_test/picnamer_server/pics/';  // the directory the pics are in
...
cmd = 'ls pic -t | sort -R | head -n 1 | tr -d [:cntrl:] > tmppicname';
exec(cmd);
}
...
// in other words, pick up a pic randomly
	...
	if(picname==""){
		...
		res.write(fs.readFileSync('./pic/'+picname));
